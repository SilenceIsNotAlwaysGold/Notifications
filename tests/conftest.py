...
os.environ["KDOCS_TRANSPORT"] = "gateway"
...
def reset_database():
    ...
    os.environ["KDOCS_MCP_CLIENT_ID"] = ""
    os.environ["KDOCS_DRIVE_ID"] = ""
    os.environ["KDOCS_ENFORCEMENT_FILE_ID"] = ""
    os.environ["KDOCS_COURT_TIME_FILE_ID"] = ""
    os.environ["KDOCS_PAYMENT_FILE_ID"] = ""
    os.environ["OCR_PROVIDER"] = "mock"
    os.environ["OCR_SIDECAR_URL"] = ""
