...
ROLE_PERMISSIONS: dict[str, list[PermissionRule]] = {
    "legal": [
        ...
        PermissionRule("GET", r"/api/v1/legal/payment-trackings"),
        PermissionRule("GET", r"/api/v1/legal/payment-trackings/unassigned-receipts"),
        PermissionRule("GET", r"/api/v1/legal/payment-trackings/daily-summary"),
        PermissionRule("POST", r"/api/v1/legal/payment-trackings/\d+/assign-receipt"),
        PermissionRule("GET", r"/api/v1/legal/attribution-queue"),
        PermissionRule("GET", r"/api/v1/legal/attribution-queue/\d+"),
        ...
        PermissionRule("POST", r"/api/v1/legal/cases/import-xlsx"),
        ...
        PermissionRule("POST", r"/api/v1/legal/media-files/reanalyze-repayment-annotations"),
        ...
        PermissionRule("GET", r"/api/v1/legal/ocr-reviews/court-summons"),
        PermissionRule("GET", r"/api/v1/legal/ocr-reviews/enforcement-documents"),
        PermissionRule("GET", r"/api/v1/legal/ocr-reviews/repayment-materials"),
        PermissionRule("GET", r"/api/v1/legal/ocr-reviews/repayment-agreements"),
        PermissionRule("POST", r"/api/v1/legal/ocr-reviews/court-summons/\d+/retry"),
        PermissionRule("POST", r"/api/v1/legal/ocr-reviews/repayment-materials/\d+/retry"),
        ...
        PermissionRule("GET", r"/api/v1/legal/kdocs-browser/tables/(enforcement|court|payment|repayment)"),
        PermissionRule("PATCH", r"/api/v1/legal/kdocs-browser/tables/(enforcement|court|payment|repayment)/rows/\d+"),
        PermissionRule("DELETE", r"/api/v1/legal/kdocs-browser/tables/(enforcement|court|payment|repayment)/rows/\d+"),
